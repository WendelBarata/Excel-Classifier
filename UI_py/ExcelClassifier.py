...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(550, 285)
        MainWindow.setMaximumSize(QSize(16777215, 285))
...
"}")
        ...
        self.lbStatusBar = QLabel(self.centralwidget)
        self.lbStatusBar.setObjectName(u"lbStatusBar")
        self.lbStatusBar.setMinimumSize(QSize(0, 33))
        self.lbStatusBar.setMaximumSize(QSize(16777215, 33))
        self.lbStatusBar.setStyleSheet(u"	padding: 4px 8px;\n"
"	background: transparent;\n"
"	border: None;\n"
"	color: rgb(46, 178, 178);\n"
"	font-size: 17px;")
        self.lbStatusBar.setAlignment(Qt.AlignCenter)

        self.gridLayout_7.addWidget(self.lbStatusBar, 4, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_7.addWidget(self.btnSplitExcel, 4, 1, 1, 1)
...
"}")
        ...
        self.gridLayout_7.addWidget(self.lbTitle, 0, 0, 1, 2)
...
"}")
        ...
        self.gridLayout_7.addWidget(self.fExcelFolderDest, 2, 0, 1, 2)
...
"}")
        ...
        self.gridLayout_7.addWidget(self.fColumnTitle, 3, 0, 1, 2)
...
"	font-size: 15px;")
        ...
        self.gridLayout_7.addWidget(self.fExcelInputFolder, 1, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Excel File", None))
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Excel File", None))
    # retranslateUi
